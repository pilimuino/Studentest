    ...
    return (
        <div className="mx-4 md:mx-19">
            ...
            <div className="mb-6 md:mb-2 md:w md:mt-2 md:pr-13">
                ...
                In that case, the user will be notified of such changes (including their entry into force) in accordance with the law. Your continued use of the Studentest service after such updates become effective will constitute acceptance of such changes
                (Both Studentest and its service providers use cookies and other technologies (such as web beacons) for a variety of reasons such as to facilitate your access to our services by reminding you when you return, to provide and analyse our services, and to provide and personalise marketing and advertising services.)
                You may at any time exercise your rights of access, rectification, cancellation and opposition by using the contact form available on this website or by sending an email to: student@example.com, stating the reason for your request.
                </p>
        </div></div>
    )
}
